...
#
export OPENSHIFT_USER_PASSWORD_DEFAULT=developer

echo $OPENSHIFT_USER_PASSWORD_DEFAULT 

if [[ ! -z OPENSHIFT_USER_PASSWORD_DEFUALT+1 ]] ; then
       echo " PASSWORD IS: ["$OPENSHIFT_USER_PASSWORD_DEFAULT"]"
fi

if [[ ! -z OPENSHIFT_USER_PASSWORD_DEFAULT ]] ; then
	echo "--> Using DEMO password for openshift"
	OPENSHIFT_PRIMARY_USER_PASSWORD_DEFAULT=$OPENSHIFT_USER_PASSWORD_DEFAULT
else
...
# - change
OPENSHIFT_PRIMARY_USER_DEFAULT=developer
